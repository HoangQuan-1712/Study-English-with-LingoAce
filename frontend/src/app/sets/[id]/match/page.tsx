'use client'
// PATH: src/app/sets/[id]/match/page.tsx
...
function Page({ id }: { id: string }) {
    ...
    return <MatchGame cards={set.cards} setId={id} setTitle={set.title} />
}

export default function Page_match({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params)
    return <Page id={id} />
}