'use client'
// PATH: src/app/sets/[id]/quiz/page.tsx
...
function Page({ id }: { id: string }) {
    ...
    return <QuizViewer cards={set.cards} setId={id} setTitle={set.title} />
}

export default function Page_quiz({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params)
    return <Page id={id} />
}